...
Mechanism: Fragility
Confidence: Direct
Unlocked: Mass-produced hybrid rice seed from a self-pollinating crop
Significance: "It forced the world's most self-contained grain to cross-breed, and the extra vigour fed hundreds of millions."
BuildsOn:
  - "[[Tooling Card - Haber-Bosch]]"
Enables:
Threads:
...
**Back.** Hybrid rice yielded [roughly 20 percent more](https://en.wikipedia.org/wiki/Hybrid_rice) than ordinary varieties and spread across China, then much of Asia and Africa, feeding hundreds of millions. The tool is the seed system itself. A farmer's own saved seed loses the vigour, so every season's hybrid seed has to be remade from the parent lines, and those lines and the crossing craft stayed in Changsha. China gave away its early varieties freely and still grows more hybrid rice than anyone else.
