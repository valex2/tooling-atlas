---
Tags: tooling-card
Name: The Fluorescence-Activated Cell Sorter
Kind: Measure
...
Confidence: Direct
Unlocked: picking one kind of living cell out of a blood sample
Significance: "By squeezing cells into single file and reading the glow off each one as it passed, the sorter turned a smear of blood into a count of named cell types, and let the wanted cells come out alive."
BuildsOn:
...
**Back.** [By 1971 it was running 5,000 live cells a second](https://med.stanford.edu/news/all-news/2013/10/leonard-herzenberg-geneticist-who-developed-key-cell-sorting-technology-dies.html), and [a 1972 rebuild swapped the mercury lamp for an argon laser](https://pubmed.ncbi.nlm.nih.gov/5013444/), which put enough light on each cell to read several stains at once. Becton Dickinson took the Stanford design and [sold the first commercial machine in 1974](https://www.the-scientist.com/in-search-of-facs-the-history-of-fluorescence-activated-cell-sorting-72141), then sold the stained antibodies to feed it, and immunology labs bought both. Herzenberg's own machine had [grown to twelve colours plus two scatter channels by 2002](https://academic.oup.com/clinchem/article/48/10/1819/5642331). When AIDS arrived, counting a patient's CD4 cells was the way to tell how far the disease had gone, and the sorter is [still the method the WHO points to for that count](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3653683/). Somewhere near [five billion dollars of these machines and their reagents](https://www.grandviewresearch.com/industry-analysis/flow-cytometry-market) now sell each year, and every one of them still breaks its stream into drops with the shaker Fulwyler borrowed from an ink-jet printer.
